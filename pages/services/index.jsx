  ...
  return (
    <section className="padding-container max-container py-12">
      <motion.div
        ...
        <h3 className="text-[30px] lg:text-[36px] font-extrabold relative leading-normal  uppercase">Servicio<span className="text-secondary">s</span>
        <br />
          <span className="text-[45px] lg:text-[54px] font-extrabold text-white/5 absolute top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 uppercase">Mis servicios</span>
        </h3>
        <p className="text-center max-w-md mx-auto text-gray-20 mt-12">Soluciones digitales personalizadas para empresas que buscan destacarse en un mercado competitivo. Desde diseño de interfaces hasta desarrollo de aplicaciones.</p>
      </motion.div>
      {/* Swiper */}
      <motion.div
